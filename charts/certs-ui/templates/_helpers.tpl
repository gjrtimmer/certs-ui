...
{{ include "certs-ui.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "certs-ui.selectorLabels" -}}
...
*/}}
{{- define "certs-ui.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "certs-ui.fullname" .) .Values.serviceAccount.name }}
{{- else }}
